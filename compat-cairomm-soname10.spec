...
License  : LGPL-2.0
Requires: compat-cairomm-soname10-data = %{version}-%{release}
Requires: compat-cairomm-soname10-lib = %{version}-%{release}
Requires: compat-cairomm-soname10-license = %{version}-%{release}
...
%package data
Summary: data components for the compat-cairomm-soname10 package.
Group: Data

%description data
data components for the compat-cairomm-soname10 package.


%package dev
Summary: dev components for the compat-cairomm-soname10 package.
Group: Development
Requires: compat-cairomm-soname10-lib = %{version}-%{release}
Requires: compat-cairomm-soname10-data = %{version}-%{release}
Provides: compat-cairomm-soname10-devel = %{version}-%{release}
Requires: compat-cairomm-soname10 = %{version}-%{release}

%description dev
dev components for the compat-cairomm-soname10 package.


%package doc
Summary: doc components for the compat-cairomm-soname10 package.
Group: Documentation

%description doc
doc components for the compat-cairomm-soname10 package.


%package lib
Summary: lib components for the compat-cairomm-soname10 package.
Group: Libraries
Requires: compat-cairomm-soname10-data = %{version}-%{release}
Requires: compat-cairomm-soname10-license = %{version}-%{release}

%description lib
lib components for the compat-cairomm-soname10 package.


%package license
Summary: license components for the compat-cairomm-soname10 package.
Group: Default

%description license
license components for the compat-cairomm-soname10 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611163452
...
%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/compat-cairomm-soname10/1679b0cb5406c6e4624f779c02e32985497f7aa7
